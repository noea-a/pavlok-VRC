...
GRAB_START_VIBRATION_TON = 10  # Grab開始バイブ ON 時間（0～255）
...
GRAB_START_VIBRATION_TOFF = 10  # Grab開始バイブ OFF 時間（0～255）
...
VIBRATION_ON_STRETCH_COUNT = 2  # Stretch超過バイブ 反復回数（1～127）
...
VIBRATION_ON_STRETCH_TON = 6  # Stretch超過バイブ ON 時間（0～255）
...
VIBRATION_ON_STRETCH_TOFF = 12  # Stretch超過バイブ OFF 時間（0～255）
