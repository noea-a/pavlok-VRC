...
_SAVEABLE_KEYS: dict[str, tuple[str, str]] = {
    ...
    "USE_VIBRATION":                      ("device", "use_vibration"),
    "MIN_STRETCH_PLATEAU":                ("logic", "min_stretch_plateau"),
    "MAX_STRETCH_FOR_CALC":               ("logic", "max_stretch_for_calc"),
    "NONLINEAR_SWITCH_POSITION_PERCENT":  ("logic", "nonlinear_switch_position_percent"),
    "INTENSITY_AT_SWITCH_PERCENT":        ("logic", "intensity_at_switch_percent"),
    "OSC_STRETCH_PARAM":                  ("osc", "stretch_param"),
    "OSC_IS_GRABBED_PARAM":               ("osc", "is_grabbed_param"),
    "OSC_ANGLE_PARAM":                    ("osc", "angle_param"),
    "OSC_IS_POSED_PARAM":                 ("osc", "is_posed_param"),
    "OSC_SEND_IP":                        ("osc.send", "ip"),
